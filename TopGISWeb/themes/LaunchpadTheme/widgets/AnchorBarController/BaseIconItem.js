  ...
  var clazz = declare([_WidgetBase, _TemplatedMixin, Evented], {
    ...
    _initPosition: function(){
      return {
        ...
        left: MIN_MARGIN,
        width: (this.config.position!=null?(this.config.position.width||PANEL_WIDTH):PANEL_WIDTH),
        height: (this.config.position!=null?(this.config.position.height||PANEL_HEIGHT):PANEL_HEIGHT),
        margin: MIN_MARGIN
      };
    },
