...
define([
    ...
    'dojo/text!./templates/ColorSelectTool.html',
    'dojo/dom-attr',
    'dojo/dom-class',
    'dojo/_base/html',
    'dojo/dom-style',
    ...
    return declare([_WidgetBase, _TemplatedMixin], {
        declaredClass: "widgets.LayerTools.tools.ColorSelectTool",
        ...
        startup: function () {
            this.inherited(arguments);
            this.map || (this.destroy(), console.log("ColorSelectTool::map required"));
            ...
            $(".styleSel li").click(function () {
                for (var i = 0; i < $(".styleSel li a").length; i++) {
                    $(".styleSel li a")[i].className = "";
                }
                $(this).find("a").addClass("selA");
            });
        },
        _init: function () {
            this._visible();
