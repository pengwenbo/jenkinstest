  ...
  function(declare, lang, on, aspect, Deferred, domClass, portalUrlUtils, portalUtils,
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      _checkConfig: function() {
        ...
        initOption(options,"BaseLayer");
        initOption(options,"ThematicLayer");
        initOption(options,"PrivateLayer");
      ...
      _initTabs: function(){
        ...
        chkAllowSearch("BaseLayer");
        chkAllowSearch("ThematicLayer");
        chkAllowSearch("PrivateLayer");
